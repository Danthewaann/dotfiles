...
run_command "installing node $MY_NODE_VERSION" "installed node $MY_NODE_VERSION" \
    "nvm install $MY_NODE_VERSION"

run_command "making node $MY_NODE_VERSION the default" "made node $MY_NODE_VERSION the default" \
    "nvm alias default $MY_NODE_VERSION"

run_command "using node $MY_NODE_VERSION" "node $MY_NODE_VERSION is being used" \
    "nvm use default"
