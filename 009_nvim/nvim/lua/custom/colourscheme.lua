...
vim.cmd("highlight Search guifg=NONE guibg=#323641")
vim.cmd("highlight IncSearch guifg=NONE guibg=#323641")
vim.cmd("highlight CurSearch guifg=NONE guibg=#323641")
vim.cmd("highlight PmenuSel guifg=#a0a8b7 guibg=#323641")
